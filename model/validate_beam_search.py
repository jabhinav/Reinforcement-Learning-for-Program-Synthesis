...
class ValBeamSearch:
    """
    Implements the beam search algorithm for decoding the most likely sequences. Detaching the computation graphs during
    validation to save memory consumption
    ...
    def search(self,
        ...
        # shape: (batch_size * beam_size, *) <- Set the same state for each element in the beam.
        ...
        for timestep in range(self.max_steps - 1):
            ...
            predictions.append(restricted_predicted_classes.detach())
            ...
            backpointers.append(backpointer.detach())
