"""
Atomic expressions and their arguments are realised as tokens which are declared here and stored
in token_op_table or op_token_table. Ref [1] to see how we tokenize expressions from DSL
