"""
Describe atomic expression, their syntax and function. Ref [1]
...
class Concat(Program):
    ...
    def get_functional_outputs(self, value):
        return [e.eval(value) for e in self.expressions]
